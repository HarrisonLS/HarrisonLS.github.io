...
#### includes
判断一个字符串是否包含在另一个字符串中，返回boolean值
...
## Proxy
学习[javascript函数式编程实践指南](https://juejin.cn/book/7173591403639865377/section/7175422876495904827)中，了解“不可变数据”概念时，作者从immutable讲到immer，在讲解immer中涉及到javascript里的Proxy知识，关于Proxy的概念可查看[MDN](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Proxy)

## AST
[AST在线解析](https://astexplorer.net/)
[https://zhuanlan.zhihu.com/p/102385477](https://zhuanlan.zhihu.com/p/102385477)

babel的转换机制就是借用AST来实现的
...
#### patch-package
可以通过改包对包源码修改，并持久化作用于工程项目中，主要原理是通过git diff去实现。用来解决一些满足不了需求的样式修改。建议将需要修改的源码包版本写死。
